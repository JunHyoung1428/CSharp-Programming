...
namespace _14_Additional
{
    internal class Property
    {
        public class Player
        {
            ...
            {
                this.hp = hp;           // 디버깅할때도 브레이크포인트를 걸어 응용가능
            }

            // <속성 (Property)>
            // Get & Set 함수의 선언을 간소화

            public event Action<int> OnChangeMp; // Tip. get-set 안에 이벤트를 둬서 동기화등에 사용
            ...
            public int SP { get; } = 10;        // 읽기전용 속성(상수처럼 사용가능)... 그냥 const 쓰자
